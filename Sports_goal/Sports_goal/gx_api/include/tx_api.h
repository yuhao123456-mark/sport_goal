   ...
   referenced in the port-specific assembly code.  */
    ...
    typedef struct TX_THREAD_STRUCT
    {
       ...
       scheduled and unscheduled.  */
        VOID (*tx_thread_schedule_hook)
        (struct TX_THREAD_STRUCT *thread_ptr, ULONG id);
       ...
       a timeout.  */
        ...
        (struct TX_THREAD_STRUCT *thread_ptr, ULONG suspension_sequence);
       ...
       the thread is entered or exits.  */
        ...
        (struct TX_THREAD_STRUCT *thread_ptr, UINT type);
#endif
...
#define TX_MUTEX_PRIORITY_CHANGE_EXTENSION
    ...
    typedef struct TX_SEMAPHORE_STRUCT
    {
       ...
       the a semaphore is put.  */
        VOID (*tx_semaphore_put_notify)
        (struct TX_SEMAPHORE_STRUCT *semaphore_ptr);
#endif
